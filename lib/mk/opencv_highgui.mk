...
SRC_CC += $(notdir $(wildcard $(OPENCV_DIR)/modules/highgui/src/window.cpp))
SRC_CC += $(notdir $(wildcard $(OPENCV_DIR)/modules/highgui/src/window_QT.cpp))

vpath %.cpp $(OPENCV_DIR)/modules/highgui/src
