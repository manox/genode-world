...
class Remoterom::Packet_base : public Ethernet_frame, public Ipv4_packet
{
	public:
		enum {
...
class Remoterom::SignalPacket : public Packet_base
{
	public:
...
class Remoterom::UpdatePacket : public Packet_base
{
	public:
...
class Remoterom::DataPacket : public Packet_base
{
	public:
...
class Remoterom::Backend_server : public Backend_server_base, public Backend_base<Backend_server>
{
	private:
...
class Remoterom::Backend_client : public Backend_client_base, public Backend_base<Backend_client>
{
	private:
...
Remoterom::Backend_server_base *Remoterom::Backend_server::_instance = nullptr;
Remoterom::Backend_client_base *Remoterom::Backend_client::_instance = nullptr;

Remoterom::Backend_server_base &Remoterom::backend_init_server()
{
	return Backend_server::instance();
}

Remoterom::Backend_client_base &Remoterom::backend_init_client()
{
